...
let person1 = new Person("Joe", 2, "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laudantium, suscipit?");
let person2 = new Person("Amy", 5, "Lorem, ipsum dolor sit amet consectetur adipisicing elit.");
...
function updateContentPane(personIndex, currentPerson) {
  document.getElementById("profilePicture").src = "images/headshot" + (personIndex + 1) + ".png";

  document.getElementById("rating").src = "images/" + currentPerson.rating + "star.png";
